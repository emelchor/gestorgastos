...
<div style="width: 100%; margin: 0px auto; background-color: #FFF;">
  <div align="center">
    <table style="width: 100%; margin: 0px auto 5px auto;" class="simple">
      <tr>
        <td  width="115" bgcolor="#FFFFCC" style="text-align: center;"><img src="usuarios/images/ugr-trp-peq.gif" width="105" height="106"></td>
        <td width="831" bgcolor="#FFFFCC" style="text-align: center;" ><div align="right" class="Estilo6">
            <p class="Estilo8">Departamento de <?php echo $VER['NOMBREDEPTO']; ?> </p>
        </div></td>
      </tr>
      <tbody>
        <tr>
